...
public class Camera2BasicFragment extends Fragment implements SeekBar.OnSeekBarChangeListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public void onProgressChanged(SeekBar seekBar, final int progress, boolean fromUser) {
        ...
        mBackgroundHandler.post(new Runnable() {
            ...
            public void run() {
                float min = 0;
                float max = progress / 100f;

                float[] curve = { 0.0000f, min, 1.0000f, max };
                ...
                try {
                    ...
                    mPreviewRequestBuilder.set(CaptureRequest.TONEMAP_MODE, CameraMetadata.TONEMAP_MODE_CONTRAST_CURVE);
                    mPreviewRequestBuilder.set(CaptureRequest.TONEMAP_CURVE, tonemapCurve);
                    mPreviewRequest = mPreviewRequestBuilder.build();
                    mCaptureSession.setRepeatingRequest(mPreviewRequest, mCaptureCallback, mBackgroundHandler);
                } catch (CameraAccessException e) {
                    e.printStackTrace();
